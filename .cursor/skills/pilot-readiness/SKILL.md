...
1. `docs/guides/operators/pilot-readiness-gates.md`
2. `.cursor/plans/pilot-charter-onboarding.plan.md` unless the user supplies a different plan
3. `docs/guides/operators/aws-pilot-runbook.md` for the AWS CDK + Amplify path
4. `docs/guides/operators/pilot-host-deployment.md` only when evaluating a fallback host
...
4. Evaluate gates from `docs/guides/operators/pilot-readiness-gates.md` in these groups: 8P3P infrastructure, policy/configuration, integration path, Decision Panel proof surface, documentation readiness, and customer readiness.
