...
**Budget context:** Serverless-only architecture targeting minimal monthly spend during development and pilot. See Cost Estimate table below for per-service pricing (all public AWS rates). Internal budget targets are documented in [`docs/foundation/roadmap.md`](../foundation/roadmap.md).
